...
static const u8 sSnowCloakDescription[] = _("Boosts evation in hail.");
static const u8 sIceBodyDescription[] = _("Snowstorm regenerates HP.");
static const u8 sLeafGuardDescription[] = _("Sun Negates Status.");
...
static const u8 sArmorTailDescription[] = _("Fast moves don't work.");
