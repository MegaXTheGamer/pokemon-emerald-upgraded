...
static const u8 sWeakArmorDescription[] =    _("Hit lowers DEF and ups SPD");
...
static const u8 sMotorDriveDescription[] =   _("ELECTRIC immunity + SPD.");
static const u8 sSteadfastDescription[] =    _("Flinching raises SPD.");
static const u8 sScrappyDescription[] =      _("NORMAL/FIGHTING hit GHOST.");
