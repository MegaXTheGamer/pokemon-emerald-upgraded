...
static const u8 sWeakArmorDescription[] = _("Contact ups DEFENSE and lowers SPEED");
static const u8 sSnowCloakDescription[] = _("Boosts evation in a snowstorm.");
static const u8 sIceBodyDescription[] = _("Snowstorm regenerates HP.");
static const u8 sLeafGuardDescription[] = _("Sunny Weather Negates Status.");
static const u8 sPixilateDescription[] = _("NORMAL moves become FAIRY");
static const u8 sMotorDriveDescription[] = _("ELECTRIC moves increase SPEED.");
static const u8 sSteadfastDescription[] = _("Flinching raises SPEED.");
static const u8 sScrappyDescription[] = _("NORMAL/FIGHTING hit GHOST type.");
static const u8 sArmorTailDescription[] = _("Priority moves have no effect.");
static const u8 sDefiantDescription[] = _("Lowered stat raises ATTCK.");
static const u8 sScreenCleanerDescription[] = _("Negates screens.");
static const u8 sMoxieDescription[] = _("Each KO raised ATTACK.");
static const u8 sAdaptabilityDescription[] = _("Same type moves are stronger.");
static const u8 sTintedLensDescription[] = _("No moves aren't very effective.");
static const u8 sJustifiedDescription[] = _("DARK moves raise ATTACK.");
