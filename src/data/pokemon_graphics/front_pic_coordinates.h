...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_URSALUNA]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  0 },
    ...
    [SPECIES_ROSERADE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ANNIHILAPE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_DUDUNSPARCE_TWO]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_DUDUNSPARCE_THREE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_CLODSIRE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_MR_RIME]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_OVERQWIL]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_OBSTAGOON]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
