const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_WOOPER]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_QUAGSIRE},
                            {EVO_ITEM, ITEM_BLACK_SLUDGE, SPECIES_CLODSIRE}},
    ...
    [SPECIES_LINOONE]    = {{EVO_LEVEL, 35, SPECIES_OBSTAGOON}},
    ...
    [SPECIES_SNORUNT]    = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_GLALIE},
    ...
    [SPECIES_KIRLIA]     = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_GARDEVOIR},
    ...
    [SPECIES_SNEASEL]     = {{EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_WEAVILE},
                             {EVO_ITEM, ITEM_RAZOR_FANG, SPECIES_SNEASLER}},
    [SPECIES_STANTLER]     = {{EVO_LEVEL, 21, SPECIES_WYRDEER}},
    [SPECIES_YANMA]     = {{EVO_LEVEL, 33, SPECIES_YANMEGA}},
    [SPECIES_CORSOLA]     = {{EVO_LEVEL, 38, SPECIES_CURSOLA}},
    [SPECIES_FARFETCHD]     = {{EVO_LEVEL, 38, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_DUNSPARCE]     = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_DUDUNSPARCE_TWO},
                               {EVO_LEVEL, 100, SPECIES_DUDUNSPARCE_THREE}},
