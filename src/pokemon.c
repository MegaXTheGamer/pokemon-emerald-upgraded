...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_FARIGIRAF - 1]    = ANIM_H_VIBRATE,
    ...
    [SPECIES_DUDUNSPARCE_TWO - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUDUNSPARCE_THREE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CLODSIRE - 1]      = ANIM_H_STRETCH,
    [SPECIES_MR_RIME - 1]       = ANIM_H_SLIDE_SLOW,
    [SPECIES_OVERQWIL - 1]      = ANIM_GROW_IN_STAGES,
    [SPECIES_OBSTAGOON - 1]     = ANIM_GROW_VIBRATE,
};
    ...
    case EVO_MODE_NORMAL:
        ...
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            case EVO_FRIENDSHIP_DAY:
                RtcCalcLocalTime();
                if (gLocalTime.hours >= 12 && gLocalTime.hours < 24 && friendship >= 200)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_FRIENDSHIP_NIGHT:
                RtcCalcLocalTime();
                if (gLocalTime.hours >= 0 && gLocalTime.hours < 12 && friendship >= 200)
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
                break;
            case EVO_LEVEL:
